                    ...
                    <div className="w-full space-y-6">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div className="grid grid-cols-2 gap-4 text-sm mb-4">
                                            <div>
                                                ...
                                                <span className="text-gray-900">+64 21 555 0123</span>
                                            </div>
                                            <div>
                                                <span className="text-[#898989]">Street Address: </span>
                                                <span className="text-gray-900">456 Queen Street</span>
                                            </div>
                                            <div>
                                                <span className="text-[#898989]">
                                                    Fallback Number:{" "}
                                            ...
                                            <div>
                                                <span className="text-[#898989]">City: </span>
                                                <span className="text-gray-900">Auckland Central</span>
                                            </div>
                                            <div>
                                                <span className="text-[#898989]">Email: </span>
                                                <span className="text-gray-900">info@voqal.com </span>
                                            </div>
                                            <div>
                                                <span className="text-[#898989]">Country: </span>
                                                <span className="text-gray-900">New Zealand</span>
                                            </div>
                                        </div>

                                        <p className="text-xs text-gray-500 leading-relaxed">
                                            Welcome to [Your Salon Name] - your trusted destination
                                            for beauty, grooming, and total relaxation. We specialize
                                            in a wide range of salon services including haircuts,
                                            styling, coloring, facials, skincare, bridal makeup, and
                                            spa treatments. Our experienced team of professionals is
                                            committed to delivering personalized care using
                                            top-quality products and the latest techniques. Whether
                                            you're preparing for a special event or simply need some
                                            self-care, we're here to help you look and feel your best
                                            in a luxurious and hygienic environment.
                                        </p>
                                    </div>
                                </div>
                            </CardContent>
                        ...
                        <div className="grid grid-cols-4 gap-8">
                            ...
                            <Card className="bg-white">
                                <CardContent className="p-6 flex items-start justify-between gap-8">
                                    <div className="flex flex-col gap-5">
                                        <h3 className="font-semibold text-3xl text-primary">342</h3>
                                        <span className="text-primary-gray text-sm">
                                            Total Team Members
                                        </span>
                                    </div>
                            ...
                            <>
                                ...
                                <Card className="bg-white">
                                    <CardContent className="p-6">
                                        ...
                                        <p className="text-sm text-gray-600 mb-4">
                                            Provide information about your business through multiple
                                            sources for comprehensive AI knowledge
                                        </p>
                                        <Textarea
                        ...
                        <Card className="bg-white">
                            <CardContent className="p-6">
                                <div className="flex items-center justify-between mb-4">
                                    <h3 className="text-lg font-semibold text-gray-900">
                                        {isAdmin ? "Services Offered" : "Services & Treatments"}
                                    </h3>
                                    ...
                                    <div className="flex items-center justify-between mb-4">
                                        ...
                                        <div className="flex items-center gap-2">
                                            <Button
                                                variant="outline"
                                                size="sm"
                                                onClick={() => setShowAddStaffService(true)}
                                                className="flex items-center gap-1"
                                            >
                                                <Plus className="h-4 w-4" />
                                                Add New
                                            ...
                                            <Button
                                                ...
                                                size="sm"
                                                onClick={() =>
                                                    setStaffServicesExpanded(!staffServicesExpanded)
                                                }
                                            >
                                        ...
                                        <div className="mb-6 p-4 border border-gray-200 rounded-lg bg-gray-50">
                                            ...
                                            <div className="grid grid-cols-2 gap-4 mb-4">
                                                <div>
                                                    ...
                                                    <Select
                                                        value={newStaffService.staffMember}
                                                        onValueChange={(value) =>
                                                            setNewStaffService({
                                                                ...newStaffService,
                                                                staffMember: value,
                                                ...
                                                <div>
                                                    ...
                                                    <Input
                                                        placeholder="e.g., 60 min"
                                                        value={newStaffService.duration}
                                                        onChange={(e) =>
                                                            setNewStaffService({
                                                                ...newStaffService,
                                                                duration: e.target.value,
                                            ...
                                            <div className="mb-4">
                                                ...
                                                <Input
                                                    placeholder="Brief description"
                                                    value={newStaffService.description}
                                                    onChange={(e) =>
                                                        setNewStaffService({
                                                            ...newStaffService,
                                                            description: e.target.value,
                                            ...
                                            {staffServices.map((service) => (
                                                ...
                                                >
                                                    ...
                                                    <Button
                                                        variant="ghost"
                                                        size="sm"
                                                        onClick={() => removeStaffService(service.id)}
                                                        className="opacity-0 group-hover:opacity-100 transition-opacity text-red-600 hover:text-red-700 hover:bg-red-50"
                                                    >
                                                        <X className="h-4 w-4" />
                                                    </Button>
                            ...
                            <CardContent className="p-6">
                                ...
                                <div className="space-y-4">
                                    {Object.entries(businessHours).map(([day, hours]) => (
                                        ...
                                        >
                                            <div
                                                className={`flex items-center gap-4 ${isAdmin && "justify-between w-full"}`}
                                            >
                                ...
                                <CardContent className="p-6 space-y-6">
                                    ...
                                    <div className="flex items-center justify-between bg-background border rounded-lg p-4">
                                        <div>
                                            ...
                                            <p className="text-xs text-gray-500">
                                                Create text transcripts of all conversations
                                            </p>
                                        </div>
                                        <Switch
                                    ...
                                    <div className="flex items-center justify-between bg-background border rounded-lg p-4">
                                        <div>
                                            ...
                                            <p className="text-xs text-gray-500">
                                                Automatically detect and block suspicious calls
                                            </p>
                                        </div>
                                        <Switch
                                    ...
                                    <div className="flex items-center justify-between bg-background border rounded-lg p-4">
                                        <div>
                                            ...
                                            <p className="text-xs text-gray-500">
                                                Allow voice messages when no one can answer the call
                                            </p>
                                        </div>
                                        <Switch
                                            checked={settings.voicemailSettings}
                                            onCheckedChange={() => toggleSetting("voicemailSettings")}
                                            className="data-[state=checked]:bg-primary cursor-pointer"
                                        />
                                    </div>
                                    ...
                                    <div className="flex items-center justify-between bg-background border rounded-lg p-4">
                                        <div>
                                            ...
                                            <p className="text-xs text-gray-500">
                                                Enable recurring appointments for regular customers
                                            </p>
                                        </div>
                                        <Switch
                                            checked={settings.repeatAppointment}
                                            onCheckedChange={() => toggleSetting("repeatAppointment")}
                                            className="data-[state=checked]:bg-primary cursor-pointer"
                                        />
                                    </div>
                                    ...
                                    <div className="flex items-center justify-between bg-background border rounded-lg p-4">
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            <Switch
                                                checked={settings.callRecordingRetention}
                                                onCheckedChange={() =>
                                                    toggleSetting("callRecordingRetention")
                                                }
                                                className="data-[state=checked]:bg-primary cursor-pointer"
                                            />
                                        </div>
