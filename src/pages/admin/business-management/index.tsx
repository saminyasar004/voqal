					...
					<Card className="bg-white">
						<CardContent className="p-4 flex w-full gap-4">
							...
							<Select
								...
								onValueChange={(select_input) =>
									setPlanFilter(select_input)
								}
							>
								...
								<TableBody>
									{filteredBusiness.map((business, i) => (
										...
										>
											...
											<TableCell className="text-warning text-center font-semibold">
												$ {business.operationalCost}
											</TableCell>
											<TableCell>
												<DropdownMenu>
													<DropdownMenuTrigger
