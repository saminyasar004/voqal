...
export default function Contact() {
	return (
		<section className="min-h-screen h-max bg-hero bg-no-repeat bg-center bg-cover py-10">
			<div className="container w-[calc(100%-3rem)] lg:w-[calc(100%-6rem)] mx-auto flex flex-col gap-4 border border-primary-gray/20 rounded-lg p-8 lg:p-12 bg-white text-center">
				...
				<div className="flex flex-col gap-6 lg:px-24">
					<div className="form-group flex flex-col lg:flex-row gap-3 items-center">
						<Input
							type="name"
							name="firstName"
