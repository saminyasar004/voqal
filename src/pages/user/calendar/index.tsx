...
export default function Calendar() {
    ...
    const formatDateRange = () => {
        ...
        const startStr = `${start.getDate()} ${start.toLocaleDateString("en-US", {
            month: "long",
        })}`;
                            ...
                            <div className="flex gap-2">
                                ...
                                <Select defaultValue="all">
                                    ...
                                    <SelectContent>
                                        ...
                                        <SelectItem value="sopia">Sopia Kim</SelectItem>
                                    ...
                                    {staffMembers.map((staff) => (
                                        ...
                                        >
                                            <CardContent className="p-5 space-y-2 text-center">
                                                ...
                                                <Badge
                                                    variant={
                                                        ["Active", "Available"].includes(staff.status)
                                                            ? "success"
                                                            : staff.status === "Busy"
                                                                ? "warning"
                                                                : staff.status === "Lunch Break"
                                                                    ? "secondary"
