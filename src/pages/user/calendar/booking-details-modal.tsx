                ...
                <div>
                    ...
                    <Tabs defaultValue="overview" className="w-full">
                                    ...
                                    <CardContent className="p-6">
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            <div>
                                                ...
                                                <span>Hair Dryer, Styling Chair, Shampoo Bowl</span>
                                            </div>
                                        </div>
                                    </CardContent>
                                </Card>
                        ...
                        <TabsContent value="note" className="mt-6">
                            <Card>
                                <CardContent className="p-6">
                                    <h3 className="font-semibold mb-4">AI Generated Notes</h3>
                                    <p className="text-gray-700">
                                        Customer Requested Blonde Highlights With Natural Look.
                                        Mentioned Sensitive Scalp - Recommend Gentle Products.
                                        First-Time Customer, Seems Excited About The Service.
                                    </p>
                                </CardContent>
                            </Card>
                        </TabsContent>
                            ...
                            <div className="space-y-6">
                                <Card>
                                    <CardContent className="p-6">
                                        <div className="flex justify-between items-start mb-4">
                                            <div>
                                                <h3 className="font-semibold">AI Call Recording</h3>
                                        ...
                                        <div>
                                            ...
                                            <div className="bg-gray-100 p-3 rounded text-sm">
                                                Hello, I'd Like To Book A Haircut And Color Appointment
                                                Please. I'm Available This Thursday Afternoon If
                                                Possible
                                            </div>
                                        </div>
                                    </CardContent>
                                ...
                                <Card>
                                    <CardContent className="p-6">
                                        <div className="flex justify-between items-start mb-4">
                                            <div>
                                                <h3 className="font-semibold">Follow Up Recording</h3>
                                                <p className="text-sm text-gray-600">
                                        ...
                                        <div>
                                            <h4 className="font-medium mb-2">Transcription:</h4>
                                            <div className="bg-gray-100 p-3 rounded text-sm">
                                                Hi, This Is Sarah. I Just Wanted To Confirm My
                                                Appointment Tomorrow At 10 AM. Thank You!
                                            </div>
                                        </div>
                                    </CardContent>
                                </Card>
                                            ...
                                            <div>
                                                ...
                                                <div className="bg-gray-100 p-3 rounded mt-2">
                                                    <p className="text-sm text-gray-700">
                                                        Successfully Booked Appointment. Customer Satisfied
                                                        With AI Interaction
                                                    </p>
                                                </div>
                                            </div>
                                ...
                                <Card>
                                    <CardContent className="p-6">
                                        ...
                                        <div className="space-y-3">
                                            <div>
                                                <span className="text-gray-600">Handled By: </span>
                                                <span className="font-medium">Lisa (Receptionist)</span>
                                            </div>
                                            <div>
                                                <span className="text-gray-600">Outcome: </span>
                        ...
                        <TabsContent value="history" className="mt-6">
                            <Card>
                                <CardContent className="p-6">
                                    <h3 className="font-semibold mb-4">Customer History</h3>
                                    ...
                                    <div>
                                        ...
                                        <div className="flex gap-2 mt-1">
                                            <Badge variant="outline">Sensitive Scalp</Badge>
                                            <Badge variant="outline">Natural Blonde Highlights</Badge>
                                        </div>
                                    </div>
                                </CardContent>
                            </Card>
