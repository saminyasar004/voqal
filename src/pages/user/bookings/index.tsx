				...
				<div className="p-6 space-y-6">
					...
					<div className="border-t border-gray-200 pt-6">
						...
						<p className="text-xs text-gray-500 leading-relaxed">
							By enabling this option, your scheduled appointment
							will automatically recur at a specified time (e.g.
							every week or every month), this eliminates the need
							to rebook it again and again.
						</p>
					</div>
				</div>
